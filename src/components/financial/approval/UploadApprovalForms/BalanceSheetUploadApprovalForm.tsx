// BalanceSheetUploadApprovalForm.tsx — Upload Approval Form for Balance Sheet module
...
export const BalanceSheetUploadApprovalForm: React.FC<ApprovalFormProps> = (props) => {
  return <BaseUploadApprovalForm {...props} />;
};

export default BalanceSheetUploadApprovalForm;
