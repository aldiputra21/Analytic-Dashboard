// BankLoanUploadApprovalForm.tsx — Upload Approval Form for Bank Loan module
...
export const BankLoanUploadApprovalForm: React.FC<ApprovalFormProps> = (props) => {
  return <BaseUploadApprovalForm {...props} />;
};

export default BankLoanUploadApprovalForm;
