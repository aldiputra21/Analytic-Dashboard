// CostCenterUploadApprovalForm.tsx — Upload Approval Form for Cost Center module
...
export const CostCenterUploadApprovalForm: React.FC<ApprovalFormProps> = (props) => {
  return <BaseUploadApprovalForm {...props} />;
};

export default CostCenterUploadApprovalForm;
