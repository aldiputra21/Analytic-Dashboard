...
export const IncomeStatementManager: React.FC = () => {
  ...
  const approvalCreate = useApproval('cfd', 'income_statement', 'create');
  const approvalEdit = useApproval('cfd', 'income_statement', 'edit');
  const approvalDelete = useApproval('cfd', 'income_statement', 'delete');
